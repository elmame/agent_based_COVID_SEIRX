...
screening_params = [ 
  # test, index case, student screen interval, teacher screen interval,
  # student mask, teacher mask, halved classes, ventilation efficiency
  ('same_day_antigen0.4', 'student', 3, 7, False, True, False, 0.36),
  ('same_day_antigen0.4', 'teacher', 3, 7, False, True, False, 0.36),
]
