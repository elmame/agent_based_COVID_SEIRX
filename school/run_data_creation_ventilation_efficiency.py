...
screening_params = [ 
  # ventilation
  ('same_day_antigen', 'student', None, None, False, False, False, 0.2),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.2),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.3),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.3),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.4),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.4),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.5),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.5),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.6),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.6),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.7),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.7),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.8),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.8),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.9),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.9),
  # ventilation + masks teachers AND students + reduced class size
  ('same_day_antigen', 'student', None, None, True, True, True, 0.2),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.2),
  ('same_day_antigen', 'student', None, None, True, True, True, 0.3),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.3),
  ('same_day_antigen', 'student', None, None, True, True, True, 0.4),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.4),
  ('same_day_antigen', 'student', None, None, True, True, True, 0.5),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.5),
  ('same_day_antigen', 'student', None, None, True, True, True, 0.6),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.6),
  ('same_day_antigen', 'student', None, None, True, True, True, 0.7),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.7),
  ('same_day_antigen', 'student', None, None, True, True, True, 0.8),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.8),
  ('same_day_antigen', 'student', None, None, True, True, True, 0.9),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.9),
  # ventilation + tests teachers AND students 2x / week
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.2),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.2),
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.3),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.3),
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.4),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.4),
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.5),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.5),
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.6),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.6),
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.7),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.7),
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.8),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.8),
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.9),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.9),
  # all measures
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.2),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.2),
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.3),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.3),
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.4),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.4),
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.5),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.5),
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.6),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.6),
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.7),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.7),
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.8),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.8),
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.9),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.9),
]
