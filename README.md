...
* Exposure duration: The time between transmission and becoming infectious (exposure duration) for every agent is drawn from a random distribution and might be different for every agent (see [section parameters] below for details).
